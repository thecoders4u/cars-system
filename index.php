...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <a class="navbar-brand" href="#">
        ...
        if(isset($_SESSION['loggedin'])){
            echo'
        <form class="searchbox" id="searchform" onsubmit="megaSearch(event)"><input id="primeval" type="text" name="text" placeholder="Start typing.." required><button id="searchb" class="btn btn-primary"><img src="send.png"></button>
        </form>
        <div id="resultee" class="result" style="background-color: white; color: black;"></div>';
        }
        else{
            echo'
        <form class="searchbox" id="searchform" onsubmit="event.preventDefault()"><input id="primeval" type="text" name="text" placeholder="Login first.." required><button id="searchb" class="btn btn-primary"><img src="send.png"></button>
        </form>
        <div id="resultee" class="result" style="background-color: white; color: black;"></div>';
        }
        ?>
