...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 text-center navpadding">
            ...
            <p>If you want to register for an account, go to the register page and fill every field, your password will have to be strong and powerful, on Login a Maximum attempts permitted are 3, if incorrect credentials are submitted, you will wait for 15 minutes to try again</p>
        </div>
        <div class="col-sm-4 text-center navpadding">
            <h3>Searching & Newsfeed:</h3>
            <p>News can be viewed in the trending page (all news) or in the home page (breif). You can only search in the Trending section for the news that is currently available, this occurs only if you login, press enter on your keyboard or click Go!</p>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-4 text-center navpadding">
